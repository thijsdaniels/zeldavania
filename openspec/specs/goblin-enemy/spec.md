...
- **THEN** the finite state machine transitions the Goblin to `GoblinStabbing`
...
- **THEN** the Goblin does not transition to `GoblinStabbing`
...
- **GIVEN** the Goblin enters `GoblinStabbing` state
...
- **GIVEN** the Goblin is in `GoblinStabbing` state
